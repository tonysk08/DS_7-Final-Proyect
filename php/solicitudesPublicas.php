...
<body>
    ...
    <!-- Incluye lo que hay que exportar para las tablas de material design -->
    <!-- DataTables CSS -->
...
<div class="container">
<table id="dtMaterialDesignExample" class="table table-striped table-bordered mt-2 mb-2"  cellspacing="0" width="50%">
  <thead>
    <tr>
      <th class="th-sm">Name
      </th>
